...
public final class Long extends Number implements Comparable<Long> {
    ...
    /// 长整型数值范围：[-9223372036854775808, 9223372036854775807]
    /**
    ...
    private static class LongCache {
        ...
        static final Long cache[] = new Long[-(-128) + 127 + 1]; // 对象缓存([-128, 127])
